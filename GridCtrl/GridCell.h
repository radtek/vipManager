...
public:
    ...
    // virtual void SetState(const DWORD_PTR nState);  -  use base class version   
    virtual void  SetFormat(DWORD_PTR nFormat)       { m_nFormat = nFormat; }                      
    ...
    // virtual DWORD_PTR    GetState() const - use base class
    virtual DWORD_PTR       GetFormat() const;
...
public:
    virtual DWORD_PTR GetStyle() const                      { return m_dwStyle;      }
    virtual void  SetStyle(DWORD_PTR dwStyle)               { m_dwStyle = dwStyle;   }
    ...
    virtual void     SetState(DWORD_PTR /*nState*/)             { ASSERT(FALSE);         }
    virtual DWORD_PTR    GetState() const                       { return CGridCell::GetState()|GVIS_READONLY; }
...
protected:
    ...
    DWORD_PTR m_dwStyle;    // Cell Style - unused
};
