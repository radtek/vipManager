...
CInPlaceEdit::CInPlaceEdit(CWnd* pParent, CRect& rect, DWORD_PTR dwStyle, UINT nID,
                           ...
                           UINT nFirstChar)
{
    ...
    DWORD_PTR dwEditStyle = WS_BORDER|WS_CHILD|WS_VISIBLE| ES_AUTOHSCROLL //|ES_MULTILINE
        | dwStyle;
