...
CGridCellDateTime::CGridCellDateTime(DWORD_PTR dwStyle) : CGridCell()
{
	Init(dwStyle);
}
...
void CGridCellDateTime::Init(DWORD_PTR dwStyle)
{
	m_dwStyle = dwStyle;
...
CInPlaceDateTime::CInPlaceDateTime(CWnd* pParent, CRect& rect, DWORD_PTR dwStyle, UINT nID,
