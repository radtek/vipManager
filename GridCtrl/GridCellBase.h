...
#define GVIS_AUTOSIZING			0x0100
#define GVIS_LAST				GVIS_AUTOSIZING
...
typedef struct _GV_ITEM {
    ...
    DWORD_PTR    nFormat;     // Format of cell
...
public:
    ...
    virtual void SetState(DWORD_PTR nState)                     { m_nState = nState; }
    virtual void SetFormat(DWORD_PTR /* nFormat */)             = 0 ;
    ...
    virtual DWORD_PTR      GetState()      const                { return m_nState;  }
    virtual DWORD_PTR      GetFormat()     const                = 0 ;
...
protected:
    DWORD_PTR    m_nState;      // Cell state (selected/focus etc)
};
