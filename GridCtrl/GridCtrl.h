...
public:
    ...
    BOOL Create(const RECT& rect, CWnd* parent, UINT nID,
                DWORD_PTR dwStyle = WS_CHILD | WS_BORDER | WS_TABSTOP | WS_VISIBLE);
...
public:
	...
	BOOL IsRowValid(int iRow) {return iRow >= 0 && iRow > m_nFixedRows-1 && iRow < GetRowCount();}
	BOOL IsSelRowValid() 
	{
...
///////////////////////////////////////////////////////////////////////////////////
 ...
 public:
    ...
    virtual DROPEFFECT OnDragEnter(COleDataObject* pDataObject, DWORD_PTR dwKeyState, CPoint point);
    virtual DROPEFFECT OnDragOver(COleDataObject* pDataObject, DWORD_PTR dwKeyState, CPoint point);
...
public:
	...
	static BOOL IsOnlyNumber(CString strTemp);
///////////////////////////////////////////////////////////////////////////////////
// Printing
///////////////////////////////////////////////////////////////////////////////////
...
protected:
    ...
    CMap<DWORD_PTR,DWORD_PTR, CCellID, CCellID&> m_SelectedCellMap, m_PrevSelectedCellMap;
